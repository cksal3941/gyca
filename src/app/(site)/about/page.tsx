    ...
    <>
          ...
          <div className="mt-12 grid gap-y-12 sm:grid-cols-2 sm:gap-x-16 lg:gap-x-24">
            {PROGRAMS.map((p) => (
              <div key={p.eyebrow} className="border-t border-line pt-6">
                <p
                  className={`text-[16px] font-bold uppercase tracking-[0.14em] ${p.accent}`}
                >
                  {p.eyebrow}
                </p>
      ...
      <section className="mx-auto max-w-shell px-6">
        <div className="border-b border-line py-16 lg:py-24">
          ...
          <p className="mt-6 text-[16px] text-ink-strong">
      ...
      <section className="mx-auto max-w-shell px-6">
        <div className="flex flex-col justify-between gap-8 py-16 lg:flex-row lg:items-end lg:py-24">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/contests"
              className="inline-flex items-center gap-2 rounded-lg bg-brand-blue px-6 py-3 text-[16px] font-semibold text-white hover:-translate-y-0.5"
            >
              공모전 보기
              <ArrowRight size={16} />
            </Link>
