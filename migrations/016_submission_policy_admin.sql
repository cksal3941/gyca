CREATE TABLE gyca_submission_policy_changes (
...
CREATE TRIGGER gyca_submission_policy_changes_immutable BEFORE UPDATE OR DELETE ON gyca_submission_policy_changes
